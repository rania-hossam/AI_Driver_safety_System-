...
# -*- coding: utf-8 -*-
"""
Created on Mon mar 22 19:10:19 2023
    ...
    if result:
        ...
        if outputs.multi_face_landmarks:
            ...
            if frame_count > min_frame:
                ...
                #speech.runAndWait()
                message = 'Drowsy Alert: It Seems you are sleeping.. please wake up you are in a car bro'
            ...
            if ratio_lips < 1.8:
                ...
                #speech.runAndWait()
                message = 'Drowsy Warning: You looks tired.. please take rest and drink some coffe'
